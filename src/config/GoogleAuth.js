...
passport.use('google-stallowner', new GoogleStrategy({
    ...
    callbackURL: "https://38bf-2001-fb1-2e-c624-315a-3b55-911c-778d.ngrok-free.app/auth/stallowner/google/callback",
...
passport.use('google-customer', new GoogleStrategy({
  clientID: process.env.GOOGLE_CLIENT_ID,
  clientSecret: process.env.GOOGLE_CLIENT_SECRET,
  callbackURL: "https://38bf-2001-fb1-2e-c624-315a-3b55-911c-778d.ngrok-free.app/auth/customer/google/callback",
  passReqToCallback: true,
},
async (request, accessToken, refreshToken, profile, done) => {
  try {
