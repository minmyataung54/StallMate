...
const Signup = () => {
    ...
    return (
        <div className="container d-flex flex-column justify-content-center align-items-center vh-100 w-100">
            ...
            />
            <p className="display-4 text-white my-4 font-weight-login text-center" style={{ fontSize: '7vw' }}>Create a New Account</p> 
            ...
            <div className="input-group" style={{ width: '90vw' }}>
                ...
                <button 
                    ...
                    style={{ width: '90vw', height: '14vw', background: '#02C543', borderRadius: '4vw', fontSize: '3.5vw', fontWeight: '500' }}
                >
                    Sign Up
                </button>
            </form>
            ...
            <div className='container d-flex justify-content-center align-items-center mt-1'>
                <button className='btn btn-custom-signup mb-4 mx-4' onClick={handleLogin}>
                    <img src={fblogo} alt="" style={{ height: '7vw', width: '7vw', alignItems: 'center' }} />
                </button>
                <button className='btn btn-custom-signup mb-4 mx-4' onClick={handleLogin}>
                    <img src={gglogo} alt="" style={{ height: '7vw', width: '7vw', alignItems: 'center' }} />
                </button>
                <button className='btn btn-custom-signup mb-4 mx-4' onClick={handleLogin}>
                    <img src={aplogo} alt="" style={{ height: '7vw', width: '7vw', alignItems: 'center' }} />
                </button>
            </div>
